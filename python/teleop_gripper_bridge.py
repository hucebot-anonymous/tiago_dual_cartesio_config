...
def io_callback(data: Float32):
    ...
    for joint_name in gripper_cmd_msg.joint_names:
        gripper_cmd_msg.points[0].positions[gripper_cmd_msg.joint_names.index(joint_name)] = gripper
...
if __name__ == '__main__':
    ...
    gripper_cmd_pub = rospy.Publisher(controller_gripper + '/command', JointTrajectory, queue_size=1)
